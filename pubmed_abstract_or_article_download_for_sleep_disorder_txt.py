...
#query='((arousal[Title/Abstract]) AND (Adverse events[Title/Abstract]))'
#query='((Post-COVID syndrome[Title/Abstract]) AND (Long COVID[Title/Abstract]) AND (disease progression[Title/Abstract]))'
#query='(moderna[Title/Abstract] AND vaccine[Title/Abstract]) OR (spikevax[Title/Abstract]) and(SARS-CoV-2[Title/Abstract]  OR COVID-19[Title/Abstract]) and (preclinical[Title/Abstract] or animal[Title/Abstract])'
#query='(moderna[Title/Abstract] AND vaccine[Title/Abstract]) OR (spikevax[Title/Abstract]) and(SARS-CoV-2[Title/Abstract]  OR COVID-19[Title/Abstract]) and (phase I[Title/Abstract] or phase 1[Title/Abstract])'
#query='(moderna[Title/Abstract] AND vaccine[Title/Abstract]) OR (spikevax[Title/Abstract]) and(SARS-CoV-2[Title/Abstract]  OR COVID-19[Title/Abstract]) and (phase II[Title/Abstract] or phase 2[Title/Abstract])'
#query='(moderna[Title/Abstract] AND vaccine[Title/Abstract]) OR (spikevax[Title/Abstract]) and(SARS-CoV-2[Title/Abstract]  OR COVID-19[Title/Abstract]) and (phase III[Title/Abstract] or phase 3[Title/Abstract])'
#query='(moderna[Title/Abstract] AND vaccine[Title/Abstract]) OR (spikevax[Title/Abstract]) and(SARS-CoV-2[Title/Abstract]  OR COVID-19[Title/Abstract]) and (phase IV[Title/Abstract] or phase 4[Title/Abstract])'
#query='moderna[Title/Abstract] AND vaccine[Title/Abstract]) OR (spikevax[Title/Abstract]) and(SARS-CoV-2[Title/Abstract]  OR COVID-19[Title/Abstract]) and (clinical trial[Title/Abstract])'
#query='moderna[Title/Abstract] AND vaccine[Title/Abstract]) OR (spikevax[Title/Abstract]) and(SARS-CoV-2[Title/Abstract]  OR COVID-19[Title/Abstract]) and (adverse event[Title/Abstract] OR side effect[Title/Abstract])'
#query='((((((mRNA-1273) OR (moderna AND vaccine) OR (spikevax)) AND (COVID-19))) AND (((phase 3) OR (phase III)))) AND ((adverse effect) OR (adverse event))) AND ((myocarditis) OR (percarditis))'
